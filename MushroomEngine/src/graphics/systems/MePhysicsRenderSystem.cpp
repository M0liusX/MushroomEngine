...
MePhysicsRenderSystem::MePhysicsRenderSystem(MeDevice& device,
...
MePhysicsRenderSystem::~MePhysicsRenderSystem()
{
   vkDestroyPipelineLayout(meDevice.device(), pipelineLayout, nullptr);
}


void MePhysicsRenderSystem::createPipelineLayout(VkDescriptorSetLayout desciptorSetLayout)
{   
...
void MePhysicsRenderSystem::createPipeline(VkRenderPass renderPass)
{
...
void MePhysicsRenderSystem::renderPhysicsObjects(FrameInfo& frameInfo)
{
